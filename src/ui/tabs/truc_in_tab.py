...
class TrucInTab(TabBase):
    ...
    def build_ui(self, main_frame):
        ...
        self.truc_in_don_gia_goc.grid(row=0, column=1, sticky='ew', padx=5, pady=5)
        ...
        self.truc_in_thanh_tien.grid(row=1, column=1, sticky='ew', padx=5, pady=5)
        ...
        self.truc_in_don_gia_ban.grid(row=0, column=3, sticky='ew', padx=5, pady=5)
        ...
        self.truc_in_thanh_tien_ban.grid(row=1, column=3, sticky='ew', padx=5, pady=5)
        ...
        self.truc_in_cong_no_khach.grid(row=2, column=1, sticky='ew', padx=5, pady=5)

        # CTV và Hoa hồng
        ttk.Label(price_frame, text="CTV:").grid(row=3, column=0, sticky='e', padx=5, pady=5)
        self.truc_in_ctv = ttk.Entry(price_frame, width=20)
        self.truc_in_ctv.grid(row=3, column=1, sticky='ew', padx=5, pady=5)
        ...
        self.truc_in_hoa_hong.grid(row=3, column=3, sticky='ew', padx=5, pady=5)
        ...
        self.truc_in_tien_hoa_hong.grid(row=4, column=1, sticky='ew', padx=5, pady=5)
        ...
        self.truc_in_loi_nhuan.grid(row=5, column=1, sticky='ew', padx=5, pady=5)
        ...
        self.truc_in_tien_ship.grid(row=5, column=3, sticky='ew', padx=5, pady=5)
        ...
        self.truc_in_loi_nhuan_rong.grid(row=6, column=1, sticky='ew', padx=5, pady=5)
    ...
    def luu_truc_in(self):
        ...
        try:
            ...
            if messagebox.askyesno("Đính kèm", "Bạn có muốn đính kèm tệp vào đơn hàng này?"):
                ...
                if file_paths:
                    self._save_attachments(order_id=don_hang.id, order_type='truc_in', file_paths=file_paths)
    ...
    def export_to_excel(self):
        ...
        try:
            ...
            file_path = filedialog.asksaveasfilename(
                ...
                initialfile=f"truc_in_{datetime.now().strftime('%Y%m%d_%H%M%S')}.xlsx"
            )
            ...
            if os.path.exists(file_path):
                ...
                headers = [
                    ...
                    'Quy cách', 'Số lượng', 'Màu sắc', 'Màu keo',
                    'Đơn giá gốc', 'Thành tiền gốc', 'Đơn giá bán',
                    'Thành tiền bán', 'Công nợ khách', 'CTV',
                    'Hoa hồng', 'Tiền hoa hồng', 'Lợi nhuận',
                    'Tiền ship', 'Lợi nhuận ròng'
                ]
            ...
            data = [
                ...
                self.mau_sac.get(),
                self.mau_keo.get(),
                self.truc_in_don_gia_goc.get(),
                self.truc_in_thanh_tien.get(),
                self.truc_in_don_gia_ban.get(),
                self.truc_in_thanh_tien_ban.get(),
                self.truc_in_cong_no_khach.get(),
                self.truc_in_ctv.get(),
                self.truc_in_hoa_hong.get(),
                self.truc_in_tien_hoa_hong.get(),
                self.truc_in_loi_nhuan.get(),
                self.truc_in_tien_ship.get(),
                self.truc_in_loi_nhuan_rong.get()
            ]
    ...
    def export_truc_in_email(self):
        try:
            ...
            subject = f"Trục in {ten_hang}" if ten_hang else "Trục in"
            content = f"""Chào bác,
